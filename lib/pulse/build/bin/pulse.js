...
pulse.RendererInterface = function() {
  var _this = this;
  var renderer, _layers = {sceneId:{active:{}, all:{}}};
  ...
  this.clearLayerSection = function(x, y, width, height, layerName, sceneId) {
    return renderer.clearLayerSection(x, y, width, height, _layers[sceneId].active[layerName] && _layers[sceneId].active[layerName].rendererLayerObj)
  };
  ...
  this.addLayer = function(pulseLayerObj, container, isActive, sceneId) {
    buildSceneLayerHolderIfNotDefined(sceneId);
    _layers[sceneId].all[pulseLayerObj.name] = {pulseLayerObj:pulseLayerObj, rendererLayerObj:_generateRendererLayerFromPulseLayer(pulseLayerObj, container, isActive)};
    if(isActive) {
      _layers[sceneId].active[pulseLayerObj.name] = _layers[sceneId].all[pulseLayerObj.name]
    }
  };
  ...
  this.prepareLayers = function(defaultWidth, defaultHeight, sceneId) {
    ...
    for(var name in _layers[sceneId].all) {
      if(_layers[sceneId].all.hasOwnProperty(name)) {
        ...
        if(_layers[sceneId].all[name].rendererLayerObj.isActive) {
          _layers[sceneId].active[name] = _layers[sceneId].all[name]
        }
  ...
  this.addVisualToLayer = function(pulseVisualObj, layerName, sceneId) {
    ...
    var visualObj = {positionPrevious:pulseVisualObj.positionPrevious, size:pulseVisualObj.size, sizePrevious:pulseVisualObj.sizePrevious, bounds:pulseVisualObj.bounds, boundsPrevious:pulseVisualObj.boundsPrevious, anchor:pulseVisualObj.anchor, anchorPrevious:pulseVisualObj.anchorPrevious, anchorRadius:pulseVisualObj.anchorRadius, anchorAngle:pulseVisualObj.anchorAngle, scale:pulseVisualObj.scale, scalePrevious:pulseVisualObj.scalePrevious, rotation:pulseVisualObj.rotation, rotationPrevious:pulseVisualObj.rotationPrevious, 
    positionTopLeft:pulseVisualObj.positionTopLeft, positionTopLeftPrevious:pulseVisualObj.positionTopLeftPrevious, invalidProperties:pulseVisualObj.invalidProperties, zindex:pulseVisualObj.zindex, zindexPrevious:pulseVisualObj.zindexPrevious, shuffled:pulseVisualObj.shuffled, alpha:pulseVisualObj.alpha, alphaPrevious:pulseVisualObj.alphaPrevious, shadow:{shadowEnabled:pulseVisualObj.shadowEnabled, shadowEnabledPrevious:pulseVisualObj.shadowEnabledPrevious, shadowOffsetX:pulseVisualObj.shadowOffsetX, 
    shadowOffsetY:pulseVisualObj.shadowOffsetY, shadowBlur:pulseVisualObj.shadowBlur, shadowColor:pulseVisualObj.shadowColor}, visible:pulseVisualObj.visible, visiblePrevious:pulseVisualObj.visiblePrevious, updated:pulseVisualObj.updated, type:pulseVisualObj.visualType || pulse._enum.VisualObjectType.VISUAL};
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name] = {pulseVisualObj:pulseVisualObj, rendererVisualObj:renderer.addVisualToLayer(visualObj, layerRef.rendererLayerObj)};
    if(_layers[sceneId].active[layerName]) {
      _layers[sceneId].active[layerName] = _layers[sceneId].all[layerName]
    }
  };
  this.removeVisualFromLayer = function(pulseVisualObj, layerName, sceneId) {
    var layerRef = _layers[sceneId].all[layerName];
    renderer.removeVisualFromLayer(layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj, layerRef.rendererLayerObj);
  ...
  this.updateVisualInLayer = function(pulseVisualObj, layerName, sceneId) {
    ...
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.visualType = pulseVisualObj.visualType;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textureFrame = pulseVisualObj.textureFrame;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textureFramePrevious = pulseVisualObj.textureFramePrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.texture = pulseVisualObj.texture;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.texturePrevious = pulseVisualObj.texturePrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textureUpdated = pulseVisualObj.textureUpdated;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.fontSizePrevious = pulseVisualObj.fontSizePrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.fontSize = pulseVisualObj.fontSize;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.font = pulseVisualObj.font;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.fontPrevious = pulseVisualObj.fontPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.fillColorPrevious = pulseVisualObj.fillColorPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.fillColor = pulseVisualObj.fillColor;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textPrevious = pulseVisualObj.textPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.text = pulseVisualObj.text;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.strokeWidthPrevious = pulseVisualObj.strokeWidthPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.strokeWidth = pulseVisualObj.strokeWidth;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.strokeColorPrevious = pulseVisualObj.strokeColorPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.strokeColor = pulseVisualObj.strokeColor;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.italicPrevious = pulseVisualObj.italicPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.italic = pulseVisualObj.italic;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.boldPrevious = pulseVisualObj.boldPrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.bold = pulseVisualObj.bold;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textBaselinePrevious = pulseVisualObj.textBaselinePrevious;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.textBaseline = pulseVisualObj.textBaseline;
    layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.verts = pulseVisualObj._private.verts;
  ...
  this.drawVisualObject = function(pulseVisualObj, layerName, sceneId) {
    ...
    switch(pulseVisualObj.visualType) {
      case pulse._enum.VisualObjectType.VISUAL:
        ...
        break;
      case pulse._enum.VisualObjectType.SPRITE:
        layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj.imageCanvasToBeDrawn = this.getCurrentFrame();
        renderer.drawSpriteVisualObject(layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj, layerRef.rendererLayerObj);
        break;
      case pulse._enum.VisualObjectType.BITMAP_LABEL:
        renderer.drawCanvasLabelVisualObject(layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj, layerRef.rendererLayerObj);
        break;
      case pulse._enum.VisualObjectType.CANVAS_LABEL:
        renderer.drawBitmapLabelVisualObject(layerRef.rendererLayerObj.visuals[pulseVisualObj.name].rendererVisualObj, layerRef.rendererLayerObj);
        break
    }
  };
  function _generateRendererLayerFromPulseLayer(pulseLayerObj, container, isActive) {
    return renderer.addLayer({isActive:isActive, containerElement:container, layerHeight:pulseLayerObj.size.height, layerWidth:pulseLayerObj.size.width, layerX:pulseLayerObj.position.x, layerY:pulseLayerObj.position.y, name:pulseLayerObj.name, zIndex:pulseLayerObj.zindex, visuals:{}})
  }
  function buildSceneLayerHolderIfNotDefined(sceneId) {
    if(!_layers.hasOwnProperty(sceneId)) {
      _layers[sceneId] = {active:{}, all:{}}
    }
  }
};
var pulse = pulse || {};
pulse.PixiRenderer = function PixiRenderer() {
};
var pulse = pulse || {};
pulse.PulseDefaultRenderer = function PulseDefaultRenderer() {
  ...
  this.clearLayerSection = function(x, y, width, height, layerObj) {
    return layerObj.context.clearRect(x, y, width, height)
  };
  ...
  this.removeVisualFromLayer = function(visualObj, layerObj) {
    ...
    return _this.clearLayerSection(clear.x, clear.y, clear.width, clear.height, layerObj)
  };
  ...
  this.drawPlainVisualObject = function(visualObj, layerObj) {
    ...
    if(visualObj.rotation !== 0) {
      var rotationX = visualObj.positionTopLeft.x + visualObj.size.width * Math.abs(visualObj.scale.x) / 2;
      var rotationY = visualObj.positionTopLeft.y + visualObj.size.height * Math.abs(visualObj.scale.y) / 2;
    ...
    ctx.drawImage(visualObj.canvas, px, py);
    ctx.restore()
  };
  this.drawSpriteVisualObject = function(visualObj, layerObj) {
    var ctx = layerObj.context;
    ctx.clearRect(0, 0, visualObj.canvas.width, visualObj.canvas.height);
    ctx.drawImage(visualObj.imageCanvasToBeDrawn, 0, 0, visualObj.size.width, visualObj.size.height)
  };
  ...
  this.drawBitmapLabelVisualObject = function(visualObj, layerObj) {
    ...
    for(var i = 0;i < visualObj.verts.length;i++) {
      ...
      if(vert.size.width !== 0 && vert.size.height !== 0) {
        ctx.drawImage(visualObj.font.image, vert.position.x, vert.position.y, vert.size.width, vert.size.height, cursor + vert.offset.x, vert.offset.y, vert.size.width, vert.size.height)
      }
...
var pulse = pulse || {};
pulse._enum = pulse._enum || {};
pulse._enum.VisualObjectType = {VISUAL:"VISUAL", SPRITE:"SPRITE", BITMAP_LABEL:"BITMAP LABEL", CANVAS_LABEL:"CANVAS LABEL"};
var pulse = pulse || {};
...
pulse.Visual = pulse.Node.extend({init:function(params) {
  ...
  this.mousein = false;
  this.visualType = pulse._enum.VisualObjectType.VISUAL;
  ...
  pulse.renderer.updateVisualInLayer(this, this.parent.name, this.parent.parent.sceneId);
  ...
  pulse.renderer.drawVisualObject(this, this.parent.name, this.parent.parent.sceneId);
  this.updated = false;
...
pulse.Sprite = pulse.Visual.extend({init:function(params) {
  ...
  this.visualType = pulse._enum.VisualObjectType.SPRITE;
...
pulse.BitmapLabel = pulse.Visual.extend({init:function(params) {
  ...
  this.visualType = pulse._enum.VisualObjectType.BITMAP_LABEL;
...
pulse.CanvasLabel = pulse.Visual.extend({init:function(params) {
  ...
  this.visualType = pulse._enum.VisualObjectType.CANVAS_LABEL;
...
pulse.CanvasLabel.PLUGIN_TYPE = "pulse.BitmapLabel";
...
pulse.Layer = pulse.Visual.extend({init:function(params) {
  ...
  if(obj instanceof pulse.Visual) {
    ...
    if(!this.objects.hasOwnProperty(obj.name)) {
      ...
      pulse.renderer.addVisualToLayer(obj, this.name, this.parent.sceneId)
    }else {
  ...
  if(this.objects.hasOwnProperty(spriteName)) {
    if(this.objects[spriteName] instanceof pulse.Visual) {
      pulse.renderer.removeVisualFromLayer(this.objects[spriteName], this.name, this.parent.sceneId)
    }
  ...
  for(var o in this.objects) {
    if(this.objects.hasOwnProperty(o) && this.objects[o] instanceof type) {
  ...
  for(var s in this.objects) {
    if(this.objects.hasOwnProperty(s) && this.objects[s] instanceof pulse.Visual) {
  ...
  var isDirty = false;
  for(var s in this.objects) {
    if(this.objects.hasOwnProperty(s) && this.objects[s].updated) {
      isDirty = true;
      break
    }
  }
  if(isDirty) {
    ...
    pulse.renderer.clearLayerSection(-this.positionTopLeft.x, -this.positionTopLeft.y, engine.size.width, engine.size.height, this.name, this.parent.sceneId);
      ...
      if(pulse.events[type] === "mouse" || pulse.events[type] === "touch") {
        ...
        if(sprite.dropAcceptEnabled) {
          for(var id in pulse.EventManager.DraggedItems) {
            if(pulse.EventManager.DraggedItems.hasOwnProperty(id)) {
...
pulse.Scene = pulse.Node.extend({init:function(params) {
  ...
  this.active = false;
  this.sceneId = "Scene_" + ~~(Math.random() * 1E7) + ~~(Math.random() * Math.random() * 9999999);
  this.events = new pulse.EventManager({owner:this, masterCallback:this.eventsCallback});
  ...
  if(layer instanceof pulse.Layer && !this.layers.hasOwnProperty(layer.name)) {
    ...
    if(this.active === true) {
      pulse.renderer.addLayer(layer, this.container, true, this.sceneId);
  ...
  if(typeof name === "string" && this.layers.hasOwnProperty(name)) {
    ...
    pulse.renderer.removeLayer(name, this.sceneId)
  }
  ...
  return pulse.renderer.getLiveLayerByName(name, this.sceneId)
  ...
  for(var o = 0;o < this._private.orderedKeys.length;o++) {
    ...
    if(layer.updated) {
      pulse.renderer.clearLayer(layer.name, this.sceneId);
...
pulse.Engine = PClass.extend({init:function(params) {
  ...
  pulse.renderer = (new pulse.RendererInterface).implement(new pulse.PulseDefaultRenderer);
