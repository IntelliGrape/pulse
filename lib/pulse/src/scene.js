...
/** @lends pulse.Scene.prototype */
{
  ...
  addLayer : function(layer, zindex) {
       ...
       !this.layers.hasOwnProperty(layer.name))
    {
      ...
      if(this.active === true) {
        ...
        pulse.renderer.addLayer(layer, this.container, true);
      }
    }
  ...
  removeLayer : function(name) {
    ...
    if(typeof name === 'string' && this.layers.hasOwnProperty(name)) {
      ...
      pulse.renderer.removeLayer(name);
    }
  ...
  getLiveLayer: function (name) {
    return pulse.renderer.getLiveLayerByName(name);
  },
  ...
  updateLiveLayers : function() {
    pulse.renderer.prepareLayers(this._private.defaultSize.width,this._private.defaultSize.height);
  },
  ...
  draw : function() {
    ...
    for(var o = 0; o < this._private.orderedKeys.length; o++) {
      ...
      if(layer.updated) {
        ...
        pulse.renderer.clearLayer(layer.name);
