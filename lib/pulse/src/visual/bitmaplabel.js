...
/** @lends pulse.BitmapLabel.prototype */
{
  ...
  init: function(params) {
    ...
    //Define the visual type for fast decision making, avoiding instanceof comparisons which are slower.
  ...
  update : function(elapsed) {
    ...
    // Plugin support.
    pulse.plugins.invoke(
      pulse.BitmapLabel.PLUGIN_TYPE,
      pulse.BitmapLabel.PLUGIN_UPDATE,
      pulse.plugin.PluginCallbackTypes.onEnter,
      this,
      arguments);
